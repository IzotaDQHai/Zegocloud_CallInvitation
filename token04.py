...
if __name__ == '__main__':
    app_id = 1347806305
    user_id = "01"
    secret = "e4143598b8c8bbbcc81ef33d2130dcc8"
    effective_time_in_seconds = 315360000
    payload = ''
    token = generate_token04(app_id,user_id,secret,effective_time_in_seconds,payload)
    print(token.token)
